...
const TABS = {
  0: mockTab(null, { id: '0' }),
  1: mockTab(`https://main--blog--adobe.${process.env.HLX_PROD_SERVER_HOST_PAGE}/`, { id: '1' }),
...
describe('Test check-tab', () => {
  ...
  it('checkTab: development url', async () => {
    ...
    proxyUrl.setAttribute('content', `https://main--bar--foo.${process.env.HLX_PROD_SERVER_HOST_PAGE}/`);
